...
const Homepage = () => {
  return (
    <div className="space-y-8">
      <div className="home-page-banner min-h-screen flex flex-col justify-center p-4 rounded-md">
        <h1 className="text-white text-5xl">Order everything at <br /> your home</h1>
      </div>
